...
.bt-wordmark{font-size:20px;font-weight:800;letter-spacing:-0.5px;background:linear-gradient(135deg,#60a5fa,#22d3ee);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
[data-theme="light"] .bt-wordmark{background:linear-gradient(135deg,#1e88e5,#0097a7);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
<div class="buddy-topbar">
  <div class="bt-left">
    <span class="bt-wordmark">Buddyliko</span>
  </div>
